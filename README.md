...
I'm a software engineer focused on building reliable, well-architected systems — from web applications to backend services and blockchain programs. I care about clean code, strong fundamentals, and writing software that scales. Currently deepening my expertise in Rust, Axum, and Solana program development.
...
**Working Knowledge:** REST APIs · WebSockets · CI/CD · SEO · Foundry · Solana

---

## Areas of Interest

- **Systems Programming** — Rust fundamentals: ownership, lifetimes, async patterns
- **Backend Engineering** — designing reliable APIs and services with Node.js, Nest.js, and Axum
- **Blockchain Development** — Solana on-chain programs, Anchor framework, PDAs, and SPL tokens
- **Software Architecture** — scalable, maintainable system design across web and desktop applications
...
**Open to collaborating on interesting engineering projects — feel free to reach out.**
